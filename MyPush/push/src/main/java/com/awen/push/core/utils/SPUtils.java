...
public final class SPUtils {
    ...
    private static final LinkedHashMap<String, SPUtils> SP_UTILS_MAP = new LinkedHashMap<>();
    ...
    private SPUtils(final String spName) {
        sp = PushApp.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = PushApp.getApp().getSharedPreferences(spName, mode);
    }
